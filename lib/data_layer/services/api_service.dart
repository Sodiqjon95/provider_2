...
import 'package:provider_2/data_layer/models/currency_item.dart';
import 'package:provider_2/data_layer/models/user_data.dart';
  ...
  Future<List<CurrencyItem>> getCurrencyList()async{
    try{
      ...
      if(response.statusCode == 200){
        List<CurrencyItem> currencyItem = (jsonDecode(response.body)as List?)
            ?.map((e) => CurrencyItem.fromJson(e)).toList()??[];
        return currencyItem;
      }else{
        throw Exception();
      }
